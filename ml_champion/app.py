...
models = mlflow.search_registered_models(filter_string="name='f1_driver_champions'")[-1]
last_version = max([int(i.version) for i in models.latest_versions])
MODEL = mlflow.sklearn.load_model(f"models:/f1_driver_champions/{last_version}")
# %%
